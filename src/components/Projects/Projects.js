        ...
        <Row style={{ justifyContent: "center", paddingBottom: "10px" }}>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              ...
              demoLink="https://proxi-pal2-f7ztcyfwa-fucciunavailables-projects.vercel.app"
            />
          </Col>
          ...
          <Col md={4} className="project-card">
            <ProjectCard
              imgPath={editor}
              isBlog={false}
              title="Markdown Previewer Made with React"
              description="Online code and markdown editor build with react.js. Online Editor which supports html, css, and js code with instant view of website. Online markdown editor for building README file which supports GFM, Custom Html tags with toolbar and instant preview.Both the editor supports auto save of work using Local Storage"
              ghLink="https://codepen.io/vanni-fucci/pen/XWxYrxm"
              demoLink="https://codepen.io/vanni-fucci/pen/XWxYrxm"              
            />
          </Col>
